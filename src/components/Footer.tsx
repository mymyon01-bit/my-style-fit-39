...
const Footer = () => {
  return (
    <footer className="hidden md:block border-t border-border/30 bg-background">
      <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-2 px-6 py-3 text-[9px] text-foreground/55 md:flex-row md:gap-4">
        <Brandmark variant="inline" className="!h-12" />
