        ...
        >
          ...
          >
                ...
                <div className="flex flex-wrap gap-1.5">
                  {existingTopics.filter(t => !selectedTopics.includes(t.name)).slice(0, 8).map(topic => (
                    <button
                      ...
                      className="rounded-full border border-border px-3 py-1.5 text-[11px] font-medium text-foreground/70 hover:text-foreground/70 hover:border-accent/20 transition-all"
                    >
            ...
            {!weather.loading && !weather.error && (
              <p className="text-[10px] text-foreground/70 mb-4">
