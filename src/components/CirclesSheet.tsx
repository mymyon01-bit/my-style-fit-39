                    ...
                    >
                      <div className="h-8 w-8 shrink-0 overflow-hidden rounded-full bg-foreground/[0.06] ring-1 ring-border/30">
                        {row.avatar_url ? (
                          ...
                          <div className="flex h-full w-full items-center justify-center text-[11px] font-semibold text-foreground/55">{initial}</div>
                        )}
                      </div>
                      <div className="min-w-0">
                        <p className="truncate text-[12px] text-foreground/85">{name}</p>
                        {row.blocked && <p className="text-[9px] text-destructive/70">Blocked</p>}
                      </div>
                    </button>
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      {!row.blocked && (
                        <button
                          ...
                          className={`flex items-center gap-1 rounded-full px-2.5 py-1 text-[9px] font-semibold transition-colors disabled:opacity-50 ${
                            row.followsBack
                        ...
                        >
                          {busyId === row.user_id ? <Loader2 className="h-2.5 w-2.5 animate-spin" /> : row.followsBack ? <UserMinus className="h-2.5 w-2.5" /> : <UserPlus className="h-2.5 w-2.5" />}
