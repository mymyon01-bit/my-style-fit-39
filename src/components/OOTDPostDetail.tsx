  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Image — adapts to natural aspect ratio of the photo (no crop, no letterbox) */}
        <div className="relative flex-shrink-0 md:w-auto md:h-[85vh] flex items-center justify-center">
          <img
            src={post.image_url}
            alt=""
            className="block max-w-full max-h-[60vh] md:max-h-[85vh] w-auto h-auto object-contain"
          />
          ...
          <div className="flex items-center flex-wrap gap-1 py-2 border-y border-border/15">
            <AuthGate action="react">
              <button
                ...
                aria-label="Like"
                className={`inline-flex h-7 items-center gap-1 rounded-full px-2 ring-1 transition-colors ${
                  reaction === "like"
            ...
            <AuthGate action="give stars">
              <button
                ...
                aria-label="Star"
                className={`inline-flex h-7 items-center gap-1 rounded-full px-2 ring-1 transition-colors disabled:opacity-40 ${
                  isStarred
            ...
            <div className="ml-auto flex items-center gap-1">
              <AuthGate action="save">
                ...
                >
                  {isSaved ? <BookmarkCheck className="h-3 w-3 fill-current" /> : <Bookmark className="h-3 w-3" />}
                </button>
              </AuthGate>
                ...
                <>
                  <AuthGate action="share">
                    <button
                      ...
                      className="inline-flex h-7 items-center gap-1 rounded-full bg-accent/[0.08] px-2 ring-1 ring-accent/30 text-accent/85 hover:bg-accent/15 hover:text-accent transition-colors"
                      aria-label="Repost"
                    >
