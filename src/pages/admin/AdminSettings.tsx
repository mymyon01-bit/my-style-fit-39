  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-border/20 bg-card/30 p-6 space-y-4">
        <p className="text-[12px] font-medium text-foreground/60">Current Admin</p>
        <p className="text-[11px] text-foreground/40 font-mono">{user?.email}</p>
        <p className="text-[11px] text-foreground/40 font-mono">{user?.id}</p>
      </div>

      <div className="rounded-xl border border-border/20 bg-card/30 p-6 space-y-3">
        <p className="text-[12px] font-medium text-foreground/60">Adding Admins</p>
