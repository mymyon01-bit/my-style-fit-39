              ...
              <>
                <div className="space-y-3">
                  <button
                    ...
                    disabled={loading}
                    className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-border/60 bg-card py-3 text-[13px] font-medium text-foreground/90 shadow-sm transition-colors hover:bg-accent/[0.04] disabled:opacity-50 md:gap-3 md:py-3.5 md:text-[14px]"
                  >
                    <svg className="h-4 w-4 md:h-[18px] md:w-[18px]" viewBox="0 0 24 24">
                  ...
                  {showApple && (
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-border/60 bg-card py-3 text-[13px] font-medium text-foreground/90 shadow-sm transition-colors hover:bg-accent/[0.04] disabled:opacity-50 md:gap-3 md:py-3.5 md:text-[14px]"
                    >
                      <svg className="h-4 w-4 md:h-[18px] md:w-[18px]" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="my-8 flex items-center gap-3 md:my-10">
                  <div className="h-px flex-1 bg-accent/[0.12]" />
                  <span className="whitespace-nowrap text-[10px] uppercase tracking-wider text-foreground/55">or sign in with email</span>
                  <div className="h-px flex-1 bg-accent/[0.12]" />
                </div>
              </>
            )}
