...
const PRIMARY_PATTERNS: Array<{ cat: PrimaryCategory; re: RegExp }> = [
  ...
  { cat: "tops", re: /\b(shirt|tee|t-shirts?|hoodie|sweater|polo|blouse|tank|knit|sweatshirt|pullover|henley|tunic|camisole|top)\b/i },
  ...
  { cat: "accessories", re: /\b(hat|cap|beanie|scarf|belt|watch|sunglasses|gloves?|tie|necklace|bracelet|earring|ring|fedora|beret|headband|bandana|jewelry|jewellery)\b/i },
];
