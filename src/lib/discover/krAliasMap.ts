...
const KR_ALIASES: Array<{ kr: string; aliases: string[]; family: string }> = [
  ...
  // jewelry & accessories
  { kr: "다이아 목걸이", aliases: ["diamond necklace", "diamond pendant", "fine jewelry"], family: "jewelry" },
  { kr: "다이아목걸이",  aliases: ["diamond necklace", "diamond pendant", "fine jewelry"], family: "jewelry" },
  { kr: "다이아몬드",   aliases: ["diamond", "fine jewelry", "luxury jewelry"], family: "jewelry" },
  { kr: "다이아",       aliases: ["diamond", "fine jewelry"], family: "jewelry" },
  { kr: "목걸이",       aliases: ["necklace", "pendant", "chain", "jewelry"], family: "jewelry" },
  { kr: "팔찌",         aliases: ["bracelet", "bangle", "jewelry"], family: "jewelry" },
  { kr: "반지",         aliases: ["ring", "band", "jewelry"], family: "jewelry" },
  { kr: "귀걸이",       aliases: ["earrings", "jewelry"], family: "jewelry" },
  { kr: "쥬얼리",       aliases: ["jewelry", "fine jewelry", "accessories"], family: "jewelry" },
  { kr: "주얼리",       aliases: ["jewelry", "fine jewelry", "accessories"], family: "jewelry" },
  { kr: "액세서리",     aliases: ["accessories", "jewelry"], family: "accessories" },
  { kr: "지갑",         aliases: ["wallet", "small leather goods"], family: "accessories" },
  { kr: "벨트",         aliases: ["belt", "accessories"], family: "accessories" },
  { kr: "시계",         aliases: ["watch", "watches"], family: "accessories" },
  // styles / moods / vibes
